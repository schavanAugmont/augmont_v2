...
class ApiClient {
  ...
  Map<String,String>  headers([String signature = '']) {
    ...
    map[HttpHeaders.acceptHeader] = "application/json";
    map[HttpHeaders.contentTypeHeader] = "application/x-www-form-urlencoded";
    map[HttpHeaders.cacheControlHeader] = "no-cache";
    map['iscustomer'] = "true";
    map['ismasking'] = "true";
    map['isapp'] = "true";
