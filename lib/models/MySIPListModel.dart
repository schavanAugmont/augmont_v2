class MySIPListModel {
  String? message;
  List<SIPData>? data;
  dynamic count;

  MySIPListModel({this.message, this.data, this.count});

  MySIPListModel.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['data'] != null) {
      data = <SIPData>[];
      json['data'].forEach((v) {
        data!.add(new SIPData.fromJson(v));
      });
    }
    count = json['count'];
  }
...
class SIPData {
  ...
  String? emandateFailedReason;
  String? sipStatus;
  bool? isSipMatured;
  bool? isSipRenewed;
  bool? isSipTerminated;
  String? sipTerminationReason;
  String? sipTerminationDate;
  bool? isActive;
